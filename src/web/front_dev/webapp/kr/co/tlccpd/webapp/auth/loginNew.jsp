...
<!--<![endif]-->
<head>
<title>::TLC[TRWTh Literature Contents]::</title>
...
<div id="mobile_menu">
	...
	<dl>
		...
		<dd>
			<ul>
				<li><a href="/boardListNew.brd?sub_title=입학공지&re_board_id=249"> 입학공지</a></li>
	...
	<dl>
		<dt>
			<a href="/haksa/06/indexNew.do" title='학사일정' />
...
<div style="width:100%; height:80px;">   
	<div style="float:left; width:80%; padding-top:10px; padding-left:10px;">
		<ul style="list-style-type:none">
			...
			<li class="gangreung">
				<span class="temperature_result">17.0˚</span>
			</li>
			<li style="float:left; padding-top:14px; line-height:120%">
				<span class="campus_name">강릉캠퍼스</span><br/><span class="nalssi">구름 조금</span>
			</li>
		</ul>
	</div>
...
<div style="padding:10px">
	<div id="loginArea">
		<form id="loginDomain" action="/auth/loginNew.do" method="post">
		...
		<input id="retUrl" name="retUrl" type="hidden" value="http://m.gwnu.ac.kr/indexNew.do"/>
